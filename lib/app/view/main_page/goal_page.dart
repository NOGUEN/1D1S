        ...
        children: [Center(
          child: Wrap(
            ...
            children: [
              ...
              ODOSGoalList(imoji: "images/icon_fire.png", circleColor: AppColors.orangeBackground, my_goal: "목표", percent: .5),
              ODOSGoalList(imoji: "images/icon_fire.png", circleColor: AppColors.redBackground, my_goal: "목표", percent: .75),
              ODOSGoalList(imoji: "images/icon_fire.png", circleColor: AppColors.blueBackground, my_goal: "목표", percent: 1),
              ODOSAddButton(buttonColor: Colors.black),
              TextButton(
                onPressed: () {
                  showDialog(context: context, builder: (context) {
                    return Dialog(child: ODOSGoalList(imoji: "images/icon_fire.png", circleColor: AppColors.redBackground, my_goal: "목표", percent: 1));
                  });
                },
                child: Text('hi'),
              )
